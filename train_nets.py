...
def get_parser():
    ...
    parser.add_argument('--weight_deacy', default=0.0005, help='learning alg momentum')
    ...
    parser.add_argument('--saver_maxkeep', default=100000, help='tf.train.Saver max keep ckpt files')
...
if __name__ == '__main__':
    ...
    # TODO 2.2 add test datasets and evla test data after each epoch


    # 3. define network, loss, optimize method, learning rate schedule, summary writer, saver
    # 3.1 inference phase
    w_init_method = tf.contrib.layers.xavier_initializer(uniform=False)
    net = get_resnet(images, args.net_depth, type='ir', w_init=w_init_method)
